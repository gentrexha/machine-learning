...
def perform_knn_on_breast_cancer(n_neighbors: int, weight: str, preprocess_method: str=None,
    ...
    if not feature_selection:
        ...
        use_features = get_best_features_with_decision_tress(
            x_train[columns_without_ID], y_train, dataset_name=breast_cancer_data_folder / 'breast_cancer_knn')
    ...
    if not search_params:
        ...
        try:
            ...
            prediction_dataframe.to_csv(
                breast_cancer_data_folder / 'grid_search_knn_breast_cancer_{}{}.csv'.format(more_info_name,
                                                                                            timestamp), index=False)
            print('Stored file as: grid_search_knn_breast_cancer_{}{}.csv'.format(more_info_name, timestamp))
...
def main(n_neighbors, weight, preprocess_method, feature_selection, feature_param, search_params):
    ...
    print('Starting the traning of dataset BREAST_CANCER with k={} and weight_function={}'
    ...
    perform_knn_on_breast_cancer(n_neighbors,
                                 weight,
