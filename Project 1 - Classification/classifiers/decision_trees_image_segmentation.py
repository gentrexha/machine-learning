...
from config import *
from utils import get_dataset_normalized, get_dataset_scaled, \
    get_best_features_with_decision_tress, get_not_correlated_features, get_dataset_min_max_scaled, get_perf


def perform_decision_trees_on_image_segmentation(preprocess_method: str=None,
    ...
    if not preprocess_method:
        print('Using raw dataset for image_segmentation decision_trees...')
        more_info_name += '_raw'

    elif preprocess_method == 'normalize':
        print('Using normalized dataset for image_segmentation decision_trees...')
        ...
        print('Using scaled dataset for image_segmentation decision trees...')
        ...
        print('Using min_max_scaled dataset for image_segmentation decision trees...')
    ...
    if not feature_selection:
        ...
        raise ValueError('Unknown feature selection algorithm')
    ...
    if not search_params:
        ...
        try:
            ...
            prediction_dataframe.to_csv(
                breast_cancer_data_folder / 'grid_search_decision_trees_image_segmentation_{}{}.csv'.format(more_info_name,
                                                                                                        timestamp),
                index=False)
            print(
                'Stored file as: grid_search_decision_trees_image_segmentation_{}{}.csv'.format(more_info_name, timestamp))
...
def main(preprocess_method, feature_selection, feature_param, search_params):
    ...
    perform_decision_trees_on_image_segmentation(preprocess_method=preprocess_method,
